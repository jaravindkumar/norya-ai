  ...
  return (
    <main className="wizardShell">
      ...
      <section className="wizardCard">
        ...
        {step === 4 && <><p className="eyebrow">Step 4 of 6</p><h2>Connect a calendar</h2><p className="authCopy">Let Norya book appointments while you work. This is optional and can be connected later.</p><div className="integrationCard"><div><strong>Google Calendar</strong><span>Your refresh token is encrypted and never exposed to the browser.</span></div><a className="button buttonQuiet" href="/api/calendar/connect">Connect</a></div></>}
